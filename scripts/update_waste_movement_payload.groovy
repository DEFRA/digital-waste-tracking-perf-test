...
String wasteDescription1 = "Update Waste Movement: ${testType} - ${threadNum} - Primary waste containing industrial waste and hazardous heavy metals"
String wasteDescription2 = "Update Waste Movement: ${testType} - ${threadNum} - Secondary waste containing plastic packaging and minor contaminants"
